...
<head>
  ...
  <body id="body-pd">
        ...
        <nav class="nav">
            <div> <a href="admin.php" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Book Store</span> </a>
                <div class="nav_list"> 
                  ...
                  <a href="Reservation.php" class="nav_link active"> <i class='bx bx-folder nav_icon'></i> <span class="nav_name">Reservations</span> </a> 
                </div>
    ...
    <div class="height-100 bg-light">
        ...
        <h1 style="text-align: center;">Reservations</h1><br><br>
    <!--Container Main end-->
</body>
</html>