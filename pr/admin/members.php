...
<head>
  ...
  <body id="body-pd">
        ...
        <nav class="nav">
            <div> <a href="admin.php" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Book Store</span> </a>
                <div class="nav_list"> 
                  ...
                  <a href="members.php" class="nav_link active"> <i class='bx bx-user nav_icon'></i> <span class="nav_name">Members</span> </a> 
    ...
    <div class="height-100 bg-light">
        ...
        <h1 style="text-align: center;">List Members</h1><br><br>
    <!--Container Main end-->
</body>
</html>